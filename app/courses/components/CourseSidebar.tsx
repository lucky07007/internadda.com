...
export function CourseSidebar({ course, isEnrolled, setIsEnrolled }: any) {
    ...
    <div className="lg:w-96">
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden sticky top-20">
        ...
        <div className="p-5">
          ...
          {!isEnrolled ? (
            ...
            <div className="space-y-2 mb-3">
              ...
              <button 
                ...
                className="w-full border-2 border-amber-500 text-amber-600 dark:text-amber-400 font-bold py-3 rounded-xl hover:bg-amber-50 dark:hover:bg-amber-900/30 transition-colors flex items-center justify-center gap-2"
              >
                <Award size={18} />
                Claim Certificate
              </button>
          ...
          <button className="w-full border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors mb-4">
            Add to Wishlist
          </button>
          ...
          <div className="flex items-center gap-4 pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
            <button className="flex-1 flex items-center justify-center gap-2 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
              <Share2 size={16} />
              Share
            </button>
            <button className="flex-1 flex items-center justify-center gap-2 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
